...
export function SettingsPage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setSettings((prev) => ({
      ...prev,
      [name]: name === 'maxUploadSize' || name === 'sessionTimeout' ? parseInt(value) : value,
    }));
  };
        ...
        <div style={{ marginTop: '$spacing-2xl' }}>
          ...
          <Card>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '$spacing-lg' }}>
              ...
              <div>
                <Label>API URL</Label>
                <p style={{ color: '#0ea5e9', margin: '0.5rem 0 0 0', fontSize: '0.875rem' }}>
                  {import.meta.env.VITE_API_URL}
                </p>
              </div>
              <div>
                <Label>Last Build</Label>
                <p style={{ color: '$text-primary', margin: '0.5rem 0 0 0', fontSize: '0.875rem' }}>
