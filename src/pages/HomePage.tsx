    ...
    <PageContainer>
      ...
      >
        ...
        <WelcomeText>
          ...
          <strong>{`${user?.roleName} (Nível ${user?.roleLevel})`}</strong>.
          Este sistema foi desenvolvido para facilitar a documentação e o acesso
          à informações críticas da infraestrutura de TI.
        </WelcomeText>
      ...
      <CardGrid>
        {quickAccessCards.map((card) => (
          <ConditionalRender key={card.id} requiredLevel={card.minLevel}>
            ...
            >
              <CardIcon css={{ color: "$primaryColor" }}>{card.icon}</CardIcon>
